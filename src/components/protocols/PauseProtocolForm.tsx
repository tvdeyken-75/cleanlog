            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
                ...
                render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between sm:justify-start sm:gap-4 rounded-lg border p-3 w-full">
                        <LabelWithTooltip htmlFor="pause_cargo_area_closed" tooltipText="Грузовой отсек заперт" className="font-normal flex items-center gap-2">
                            <Lock className="h-4 w-4"/>
                            Laderaum abgeschlossen
                        </LabelWithTooltip>
                        <FormControl>
                            <Switch checked={field.value} onCheckedChange={field.onChange} id="pause_cargo_area_closed" />
                        </FormControl>
                    </FormItem>
                )}
                />
                ...
                render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between sm:justify-start sm:gap-4 rounded-lg border p-3 w-full">
                        <LabelWithTooltip htmlFor="pause_has_seal" tooltipText="Пломба в наличии" className="font-normal flex items-center gap-2">
                            <Award className="h-4 w-4"/>
                            Siegel vorhanden
                        </LabelWithTooltip>
                        <FormControl>
                            <Switch checked={field.value} onCheckedChange={field.onChange} id="pause_has_seal" />
                        </FormControl>
                    </FormItem>
                )}
                />
